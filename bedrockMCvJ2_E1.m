function bedrockMCvJ2_E1(snr,nwalkers,nmodmax,nmodacc,samplepath,lburnin,savepath,sampleID,Tdglac,k_meanlength,acctarget)
...
%     model.mp{model.Mmp+(i-1)*model.Nsmp+6}.vmax = 2; %2=100 m/Myr
    ...
    model.mp{model.Mmp+(i-1)*model.Nsmp+7}.vmax = 1; %2=100 m/Myr
...
%         end
        ...
        elseif (acount < model.Nmod)
            ...
            k = k*((1-accfac) + accfac*accrat/acctarget); %target acceptance ratio 0.25
