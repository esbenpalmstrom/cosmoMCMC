% Calculate average 36Cl production rates within sample of mean thickness,
% based on CronusCalc functions

% input: 
% z: depths of interest [g/cm^2]
% Cl36chem: bulk rock and target chemistry of sample, structure as follows:
%
...
function out=get36clProd(Cl36chem,z)
addpath('./Functions/cl36/scaling')
scaling_model = 'st'; %I do not consider time-dependent production for now
sampledata = Cl36chem;
...
[~,Prods,Prodth,Prodth1,Prodth2,Prodth3,Prodth4,Prodeth,Prodeth1,Prodeth2,Prodeth3,~,Prodnm,Prodfm]=prodz36(z,pp,sf,cp);
...
out.Lth3=cp.Lthss;
out.P36eth=Prodeth;
out.P36eth1=Prodeth1;
out.P36eth2=Prodeth2;
out.P36eth3=Prodeth3;
